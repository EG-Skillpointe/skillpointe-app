...
class Login extends Component {
    ...
    render() {
        const googleButton = 
            <button className="tp-login-button goog">
        ...
        const facebookButton = 
            <button className="tp-login-button fb">
                <div className="tp-login-contents">
                <img class="img" src="https://static.xx.fbcdn.net/rsrc.php/v3/yN/r/szGrb_tkxMW.png" alt="" width="24" height="24"></img>
