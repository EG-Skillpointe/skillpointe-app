            ...
            <div className="certification-container" style={{padding:'0 20px 0', margin:"0 30px 30px", width:"315px"}}>
                ...
                <div className="certification-item" style={{height:"50px", alignItems:"center"}}>
                    <div style={{display:"flex", flexDirection:"column", justifyContent:"center", width:"auto", height:"100%"}}>
                        <h6 className="certification-text" style={{paddingLeft:"15px", margin:"5px 0",  lineHeight:"100%", width:"85%", color:"#2D426B"}}><b>Northern Georgia Community</b></h6>
                ...
                <div className="certification-item" style={{height:"50px", alignItems:"center"}}>
                    <div style={{display:"flex", flexDirection:"column", justifyContent:"center", width:"auto", height:"100%"}}>
                        <h6 className="certification-text" style={{paddingLeft:"15px", margin:"5px 0",  lineHeight:"100%", width:"85%", color:"#2D426B"}}><b>Fortis College</b></h6>
                        <h6 className="certification-text" style={{paddingLeft:"15px", margin:"5px 0", fontSize:"12px", lineHeight:"100%", width:"auto"}}>Smyrna, GA</h6>
                    </div>
                    <img src={check} alt="" style={{width:"25px", position:"absolute", top:"40%", right:"20px"}}/>
                </div>
                <button style={{border:"none", color:"#FFFFFF", backgroundColor:"#F8A141", height:"22px", width:"80%", margin:"auto", fontSize:"12px", fontFamily:"Roboto", fontWeight:"bold", borderRadius:"5px", lineHeight:"14px"}}>Explore Training</button>
            </div>
        )
    } else {
        return (
            <div className="certification-container" style={{padding:'0px 14px 0px 14px', marginBottom:"10px"}}>
                ...
                <button style={{border:"none", color:"#FFFFFF", backgroundColor:"#F8A141", height:"25px", width:"70%", margin:"8px 46px 12px 46px", fontSize:"12px", fontFamily:"Roboto", fontWeight:"bold", borderRadius:"5px", lineHeight:"14px"}}>More Atlanta Welding Schools</button>
            </div>
        )
    }
};
