...
export const WeldingSchools = (props) => {
    if (props.smallVersion) {
        ...
        return (
            <div className="certification-container" style={{padding:'16px 20px 16px 20px', marginBottom:"10px"}}>
                <h5 className="certification-header" style={{margin:"10px auto"}}>Welding Schools in you area</h5>
                <div className="certification-item" style={{height:"50px", alignItems:"center"}}>
                    <div style={{display:"flex", flexDirection:"column", justifyContent:"center", width:"auto", height:"100%"}}>
