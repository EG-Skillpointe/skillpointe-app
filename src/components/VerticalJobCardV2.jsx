...
export const VerticalJobCard = (props) => {
  ...
  return (
      ...
      <Card className="ambassador-card-container flex">
        <Card.Img variant="top" src={image} style={{height: '40%', width: '80%', borderRadius: "10px 10px 0 0"}} />
        <Card.Body style={jobPageStyle}>
          <div style={{width:"100%", height:"100%", overflow:"hidden"}}>
            <h6 style={{margin:"0", fontSize:"8px"}}>{props.job.datePosted}</h6>
            <Card.Title style={{margin:"5px 0", fontSize:"10px", lineHeight:"12px"}}>{props.job.title}</Card.Title>
