    ...
    return (
        <div style={{display:"flex", justifyContent:"space-between", flexWrap:"wrap"}}>
            <Card style={{width:"30%", height:"110px", backgroundColor:"#FFFFFF", borderRadius:"5px"}}>
                ...
                <Card.Text style={{width:"90%", margin:"12px auto", color:"#F8A141", fontSize:"16px"}}>$37,961 - $85,000</Card.Text>
            </Card>
            ...
            <Card style={{width:"30%", height:"110px", backgroundColor:"#FFFFFF", borderRadius:"5px"}}>
                ...
                <Card.Text style={{width:"90%", margin:"12px auto", color:"#F8A141", fontSize:"16px"}}>300,000 Workers</Card.Text>
            </Card>

            <Card style={{marginTop:"20px", width:"47.5%", height:"160px", backgroundColor:"#FFFFFF", borderRadius:"5px"}}>
